...
//				}
    ...
    public boolean executeSingle(Currency currency) {
        ...
        if(NumUtil.parseNumFromStr(data_report0.getString("gsjlr")) < NumUtil.parseNumFromStr(data_report4.getString("gsjlr"))|| data_report0.getDoubleValue("jqjzcsyl")<data_report4.getDoubleValue("jqjzcsyl")){
            return false;
        }
