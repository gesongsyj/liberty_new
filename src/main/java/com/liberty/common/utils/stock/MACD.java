        ...
        if (lastKline == null) {
            for (int i = 0; i < klines.size(); i++) {
                ...
                if (i == 0) {
                    ...
                    kline_current.setAoi(kline_current.getOpen() > 0 ? (kline_current.getClose() - kline_current.getOpen()) / kline_current.getOpen() : 0);
                } else {
                    ...
                    kline_current.setAoi(kline_pre.getClose() > 0 ? (kline_current.getClose() - kline_pre.getClose()) / kline_pre.getClose() : 0);
            ...
            for (int i = 0; i < klines.size(); i++) {
                ...
                if (i == 0) {
                    ...
                    kline_current.setBar(2 * (kline_current.getDiff() - kline_current.getDea()));
                    kline_current.setAoi(lastKline.getClose() > 0 ? (kline_current.getClose() - lastKline.getClose()) / lastKline.getClose() : 0);
                } else {
                    Kline kline_pre = klines.get(i - 1);
                    kline_current.setEmaS(kline_pre.getEmaS() * (sp - 1) / (sp + 1)
                            + kline_current.getClose() * 2 / (sp + 1));
