package com.liberty.common.plugins.threadPoolPlugin;
...
public class ThreadPoolPlugin implements IPlugin {
	...
	private static final int ThreadPool_queueSize = 1024;
	...
	public ThreadPoolPlugin() {
		this(DEFAULT, ThreadPool_coreSize, ThreadPool_maxSize, ThreadPool_queueSize, ThreadPool_keepAliveTime);
	}
